...
public class WaveManager : MonoBehaviour
{
    ...
    public CanvasData CanvasDataPlayer1;
    public CanvasData CanvasDataPlayer2;
    ...
    private IEnumerator StartNextWave()
    {
        ...
        {
            CanvasDataPlayer1.waveText.text = "Oleada " + (currentWaveIndex + 1) + " comienza en 10 segundos...";
            CanvasDataPlayer2.waveText.text = "Oleada " + (currentWaveIndex + 1) + " comienza en 10 segundos...";
            yield return new WaitForSeconds(10f);

            CanvasDataPlayer1.waveText.text = "Wave " + (currentWaveIndex + 1);
            CanvasDataPlayer2.waveText.text = "Wave " + (currentWaveIndex + 1);
        ...
        {
            CanvasDataPlayer1.waveText.text = "Oleada superada!";
            CanvasDataPlayer2.waveText.text = "Oleada superada!";
        }
    }
    ...
    {
        CanvasDataPlayer1.enemiesRemainingText.text = "Enemigos restantes: " + enemiesRemaining;
        CanvasDataPlayer2.enemiesRemainingText.text = "Enemigos restantes: " + enemiesRemaining;
    }
